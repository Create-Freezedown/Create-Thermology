...
public class BoilerTankRenderer extends SafeBlockEntityRenderer<BoilerTankBlockEntity> {
    
    public BoilerTankRenderer(BlockEntityRendererProvider.Context context) {
    }
    
    @Override
    protected void renderSafe(BoilerTankBlockEntity be, float partialTicks, PoseStack ms, MultiBufferSource buffer,
