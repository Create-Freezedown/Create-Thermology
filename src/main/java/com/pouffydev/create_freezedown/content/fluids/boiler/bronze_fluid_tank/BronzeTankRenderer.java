...
public class BronzeTankRenderer extends SafeBlockEntityRenderer<BronzeTankBlockEntity> {
    
    public BronzeTankRenderer(BlockEntityRendererProvider.Context context) {
    }
    
    @Override
    protected void renderSafe(BronzeTankBlockEntity be, float partialTicks, PoseStack ms, MultiBufferSource buffer,
    ...
    @Override
    public boolean shouldRenderOffScreen(BronzeTankBlockEntity be) {
