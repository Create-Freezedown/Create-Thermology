...
public class BronzeTankModel extends CTModel {
    ...
    public static BronzeTankModel standard(BakedModel originalModel) {
        return new BronzeTankModel(originalModel, FLUID_TANK, FLUID_TANK_TOP,
                FLUID_TANK_INNER);
    }
    
    
    private BronzeTankModel(BakedModel originalModel, CTSpriteShiftEntry side, CTSpriteShiftEntry top,
