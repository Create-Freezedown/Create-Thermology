...
import static com.pouffydev.create_freezedown.foundation.client.CTSpriteShifts.*;

public class BoilerTankModel extends CTModel {
    ...
    public static BoilerTankModel standard(BakedModel originalModel) {
        return new BoilerTankModel(originalModel, BOILER_TANK, BOILER_TANK_TOP,
                BOILER_TANK_INNER);
    }
    
    
    private BoilerTankModel(BakedModel originalModel, CTSpriteShiftEntry side, CTSpriteShiftEntry top,
