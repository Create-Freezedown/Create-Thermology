...
public class BoilerTankItem extends BlockItem {
    
    public BoilerTankItem(Block block, Properties properties) {
    ...
    private void tryMultiPlace(BlockPlaceContext ctx) {
        ...
        if (!BoilerTankBlock.isTank(placedOnState))
            return;
        BoilerTankBlockEntity tankAt = ConnectivityHandler.partAt( CTBlockEntityTypes.boilerTank.get(), world, placedOnPos
        );
        if (tankAt == null)
            return;
