...
public class FreezableMixerInstance extends EncasedCogInstance implements DynamicInstance {
    
    private final RotatingData mixerHead;
    private final OrientedData mixerPole;
    private final FreezableMixerBlockEntity mixer;
    
    public FreezableMixerInstance(MaterialManager materialManager, FreezableMixerBlockEntity blockEntity) {
