...
public class FreezableMixerRenderer extends KineticBlockEntityRenderer<FreezableMixerBlockEntity> {
    
    public FreezableMixerRenderer(BlockEntityRendererProvider.Context context) {
        super(context);
    }
    
    @Override
    public boolean shouldRenderOffScreen(FreezableMixerBlockEntity be) {
        return true;
    }
    
    @Override
    protected void renderSafe(FreezableMixerBlockEntity be, float partialTicks, PoseStack ms, MultiBufferSource buffer,
