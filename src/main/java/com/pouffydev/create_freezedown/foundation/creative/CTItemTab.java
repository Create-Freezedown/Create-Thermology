...
public class CTItemTab {
    private static final DeferredRegister<CreativeModeTab> REGISTER =
            DeferredRegister.create(Registries.CREATIVE_MODE_TAB, Thermology.ID);
    ...
    public static final RegistryObject<CreativeModeTab> BASE_CREATIVE_TAB = REGISTER.register("base",
            () -> CreativeModeTab.builder()
                    ...
                    .icon(CTItems.thermalloy_ingot::asStack)
                    .displayItems(new RegistrateDisplayItemsGenerator(true, CTItemTab.BASE_CREATIVE_TAB))
                    .build());
    ...
    private record RegistrateDisplayItemsGenerator(boolean addItems,
        ...
        private List<Item> collectBlocks(Predicate<Item> exclusionPredicate) {
            ...
            for (RegistryEntry<Block> entry : Thermology.REGISTRATE.getAll(Registries.BLOCK)) {
        ...
        private List<Item> collectItems(Predicate<Item> exclusionPredicate) {
            List<Item> items = new ReferenceArrayList<>();
            for (RegistryEntry<Item> entry : Thermology.REGISTRATE.getAll(Registries.ITEM)) {
                if (!CreateRegistrate.isInCreativeTab(entry, tabFilter))
                    continue;
                Item item = entry.get();
