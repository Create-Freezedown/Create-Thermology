...
public class CTLang {
    ...
    public static MutableComponent translateDirect(String key, Object... args) {
        return Components.translatable(Thermology.ID + "." + key, resolveBuilders(args));
    }
    ...
    public static LangBuilder builder() {
        return new LangBuilder(Thermology.ID);
    }
    ...
    public static MutableComponent toTemperatureIntString(float celsus) {
        return builder().translate(GuiUtils.toTemperatureIntString(celsus)).component();
    }
    public static MutableComponent toTemperatureIntStringFahrenheit(float fahrenheit) {
        return builder().translate(GuiUtils.toTemperatureIntStringFahrenheit(fahrenheit)).component();
    }
    //
